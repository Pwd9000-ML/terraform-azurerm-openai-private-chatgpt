...
resource "azurerm_subnet" "az_openai_subnet" {
  ...
  private_link_service_network_policies_enabled = var.subnet_config.private_link_service_network_policies
  private_endpoint_network_policies_enabled     = var.subnet_config.private_endpoint_network_policies
